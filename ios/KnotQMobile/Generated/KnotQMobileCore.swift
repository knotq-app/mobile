...
public protocol MobileCoreProtocol: AnyObject, Sendable {
    ...
    func deliveredNotificationsToClear(now: String?) throws  -> [String]
...
open func applyNotificationAction(actionId: String, schemeId: String, itemId: String, occurrenceJson: String, triggerAt: String)throws  -> Bool  {
    ...
    uniffi_knotq_mobile_core_fn_method_mobilecore_apply_notification_action(
        ...
        FfiConverterString.lower(schemeId),
        FfiConverterString.lower(itemId),
        FfiConverterString.lower(occurrenceJson),
        FfiConverterString.lower(triggerAt),$0
    )
})
}
...
open func commitEventEdit(schemeId: String, itemId: String, occurrenceJson: String, occurrenceIndex: Int32, title: String, occurrenceStart: String?, occurrenceEnd: String?, start: String?, end: String?, rrule: String?, notificationOffsetSecs: Int32?, notificationDirty: Bool, done: Bool, scope: String)throws   {try rustCallWithError(FfiConverterTypeMobileError_lift) {
    uniffi_knotq_mobile_core_fn_method_mobilecore_commit_event_edit(
        ...
        FfiConverterString.lower(itemId),
        FfiConverterString.lower(occurrenceJson),
        FfiConverterInt32.lower(occurrenceIndex),
        FfiConverterString.lower(title),
        FfiConverterOptionString.lower(occurrenceStart),
        FfiConverterOptionString.lower(occurrenceEnd),
        FfiConverterOptionString.lower(start),
        FfiConverterOptionString.lower(end),
        FfiConverterOptionString.lower(rrule),
        FfiConverterOptionInt32.lower(notificationOffsetSecs),
        FfiConverterBool.lower(notificationDirty),
        FfiConverterBool.lower(done),
...
open func deliveredNotificationsToClear(now: String?)throws  -> [String]  {
    return try  FfiConverterSequenceString.lift(try rustCallWithError(FfiConverterTypeMobileError_lift) {
    uniffi_knotq_mobile_core_fn_method_mobilecore_delivered_notifications_to_clear(
            self.uniffiCloneHandle(),
        FfiConverterOptionString.lower(now),$0
    )
})
}
...
open func pendingNotifications(now: String?, horizonDays: Int32)throws  -> [MobileNotificationRequest]  {
    ...
    uniffi_knotq_mobile_core_fn_method_mobilecore_pending_notifications(
            self.uniffiCloneHandle(),
        FfiConverterOptionString.lower(now),
        FfiConverterInt32.lower(horizonDays),$0
    )
})
}
...
open func setItemRecurrence(schemeId: String, itemId: String, rrule: String?)throws   {try rustCallWithError(FfiConverterTypeMobileError_lift) {
    uniffi_knotq_mobile_core_fn_method_mobilecore_set_item_recurrence(
        ...
        FfiConverterString.lower(schemeId),
        FfiConverterString.lower(itemId),
        FfiConverterOptionString.lower(rrule),$0
    )
}
}
...
open func setNotificationDefaults(eventOffsetSecs: Int32, assignmentOffsetSecs: Int32)throws   {try rustCallWithError(FfiConverterTypeMobileError_lift) {
    uniffi_knotq_mobile_core_fn_method_mobilecore_set_notification_defaults(
            self.uniffiCloneHandle(),
        FfiConverterInt32.lower(eventOffsetSecs),
        FfiConverterInt32.lower(assignmentOffsetSecs),$0
    )
}
}
...
public struct MobileGoogleAuthRequest: Equatable, Hashable {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(authUrl: String, state: String, codeVerifier: String, redirectUri: String, scope: String, clientId: String) {
...
#if compiler(>=6)
extension MobileGoogleAuthRequest: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeMobileGoogleAuthRequest: FfiConverterRustBuffer {
    ...
    public static func write(_ value: MobileGoogleAuthRequest, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMobileGoogleAuthRequest_lift(_ buf: RustBuffer) throws -> MobileGoogleAuthRequest {
    return try FfiConverterTypeMobileGoogleAuthRequest.lift(buf)
}
...
public struct MobileGoogleSyncResult: Equatable, Hashable {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(importedCount: Int32, syncedCount: Int32, failureCount: Int32, message: String) {
...
#if compiler(>=6)
extension MobileGoogleSyncResult: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeMobileGoogleSyncResult: FfiConverterRustBuffer {
    ...
    public static func write(_ value: MobileGoogleSyncResult, into buf: inout [UInt8]) {
        FfiConverterInt32.write(value.importedCount, into: &buf)
        FfiConverterInt32.write(value.syncedCount, into: &buf)
        FfiConverterInt32.write(value.failureCount, into: &buf)
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMobileGoogleSyncResult_lift(_ buf: RustBuffer) throws -> MobileGoogleSyncResult {
    return try FfiConverterTypeMobileGoogleSyncResult.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMobileGoogleSyncResult_lower(_ value: MobileGoogleSyncResult) -> RustBuffer {
    return FfiConverterTypeMobileGoogleSyncResult.lower(value)
}
...
public struct MobileNode: Equatable, Hashable {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(kind: String, id: String, name: String, colorIndex: Int32?, isDailyQueue: Bool, isReadOnly: Bool, children: [MobileNode]) {
        self.kind = kind
        self.id = id
        self.name = name
...
public struct MobileNotificationRequest: Equatable, Hashable {
    public var id: String
    ...
    public var occurrenceJson: String
    public var triggerAt: String
    ...
    public init(id: String, notificationKey: String, fireAt: String, expiresAt: String?, endAt: String?, title: String, body: String, kind: String, schemeId: String, itemId: String, occurrenceJson: String, triggerAt: String) {
        ...
        self.itemId = itemId
        self.occurrenceJson = occurrenceJson
...
#if compiler(>=6)
extension MobileNotificationRequest: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeMobileNotificationRequest: FfiConverterRustBuffer {
    ...
    public static func write(_ value: MobileNotificationRequest, into buf: inout [UInt8]) {
        FfiConverterString.write(value.id, into: &buf)
        ...
        FfiConverterString.write(value.occurrenceJson, into: &buf)
        FfiConverterString.write(value.triggerAt, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMobileNotificationRequest_lift(_ buf: RustBuffer) throws -> MobileNotificationRequest {
    return try FfiConverterTypeMobileNotificationRequest.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMobileNotificationRequest_lower(_ value: MobileNotificationRequest) -> RustBuffer {
    return FfiConverterTypeMobileNotificationRequest.lower(value)
}
...
public struct MobileOccurrence: Equatable, Hashable {
    ...
    public var itemId: String
    public var occurrenceJson: String
    public var occurrenceIndex: Int32
    public var isRecurring: Bool
    public var canDeleteFuture: Bool
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(schemeId: String, itemId: String, occurrenceJson: String, occurrenceIndex: Int32, isRecurring: Bool, canDeleteFuture: Bool, schemeName: String, colorIndex: Int32, isReadOnly: Bool, title: String, kind: String, done: Bool, start: String?, end: String?, notificationOffsetSecs: Int32?, localDate: String?, repeatRule: String?) {
        self.schemeId = schemeId
        self.itemId = itemId
        self.occurrenceJson = occurrenceJson
        self.occurrenceIndex = occurrenceIndex
        self.isRecurring = isRecurring
        self.canDeleteFuture = canDeleteFuture
...
public struct FfiConverterTypeMobileOccurrence: FfiConverterRustBuffer {
    ...
    public static func write(_ value: MobileOccurrence, into buf: inout [UInt8]) {
        ...
        FfiConverterString.write(value.itemId, into: &buf)
        FfiConverterString.write(value.occurrenceJson, into: &buf)
        FfiConverterInt32.write(value.occurrenceIndex, into: &buf)
        FfiConverterBool.write(value.isRecurring, into: &buf)
        FfiConverterBool.write(value.canDeleteFuture, into: &buf)
...
public struct MobileScheme: Equatable, Hashable {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(id: String, name: String, displayName: String, colorIndex: Int32, isDailyQueue: Bool, isReadOnly: Bool, date: String?, items: [MobileItem]) {
        self.id = id
        self.name = name
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterSequenceTypeMobileNotificationRequest: FfiConverterRustBuffer {
    typealias SwiftType = [MobileNotificationRequest]

    public static func write(_ value: [MobileNotificationRequest], into buf: inout [UInt8]) {
        let len = Int32(value.count)
        writeInt(&buf, len)
        for item in value {
            FfiConverterTypeMobileNotificationRequest.write(item, into: &buf)
        }
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [MobileNotificationRequest] {
        let len: Int32 = try readInt(&buf)
        var seq = [MobileNotificationRequest]()
        seq.reserveCapacity(Int(len))
        for _ in 0 ..< len {
            seq.append(try FfiConverterTypeMobileNotificationRequest.read(from: &buf))
        }
        return seq
    }
}
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_knotq_mobile_core_checksum_method_mobilecore_delivered_notifications_to_clear() != 16078) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_knotq_mobile_core_checksum_method_mobilecore_set_item_recurrence() != 54120) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_knotq_mobile_core_checksum_method_mobilecore_set_notification_defaults() != 46232) {
        return InitializationResult.apiChecksumMismatch
    }
